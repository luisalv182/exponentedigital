...
require(dirname(__FILE__) . '/NaturalPerson.php');
require(dirname(__FILE__) . '/NaturalPersonTenDigitsCalculator.php');
require(dirname(__FILE__) . '/HomoclaveCalculator.php');
require(dirname(__FILE__) . '/VerificationDigitCalculator.php');
require(dirname(__FILE__) . '/Rfc.php');
